...
internal static class TelemetryTagNames
{
    ...
    // Error tags
    /// <summary>Standard OTel attribute. Describes a class of error the operation ended with.</summary>
    public const string ErrorType = "error.type";
    /// <summary>Custom attribute. Whether this is a product or user error.</summary>
    public const string ErrorCategory = "dotnetup.error.category";
    /// <summary>Custom attribute. Domain-specific error code (e.g. DotnetInstallException.ErrorCode).</summary>
    public const string ErrorCode = "dotnetup.error.code";
    /// <summary>Custom attribute. Additional human-readable error detail (no PII).</summary>
    public const string ErrorMessage = "dotnetup.error.message";
    /// <summary>Custom attribute. Additional sanitized context about the error.</summary>
    public const string ErrorDetails = "dotnetup.error.details";
    /// <summary>Custom attribute. HTTP status code associated with the error.</summary>
    public const string ErrorHttpStatus = "dotnetup.error.http_status";
    /// <summary>Custom attribute. Win32 HRESULT associated with the error.</summary>
    public const string ErrorHResult = "dotnetup.error.hresult";
    /// <summary>Custom attribute. Stack trace for diagnostic purposes.</summary>
    /// <summary>Custom attribute. Chain of exception types for diagnostic purposes.</summary>
    public const string ErrorExceptionChain = "dotnetup.error.exception_chain";
